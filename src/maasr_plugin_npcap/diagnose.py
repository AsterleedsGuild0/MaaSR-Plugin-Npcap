...
def diagnose_ports() -> None:
    ...
    from maasr_plugin_npcap.process_ports import (
        build_bpf_filter,
        discover_game_ports,
    )
...
def replay_packets(input_file: str) -> None:
    ...
    from maasr_plugin_npcap.message_parser import (
        WORLD_NTF_SERVICE_UUID,
        MessageParser,
    )
    from maasr_plugin_npcap.player_tracker import PlayerTracker
    from maasr_plugin_npcap.tcp_reassembly import TcpReassembler
